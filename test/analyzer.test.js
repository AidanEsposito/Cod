...
const semanticChecks = [
  ...
  ["number type array", "number[] x = [1, 2, 3]"],
  ["boolean type array", "boolean[] x = [hooked, unhooked, hooked]"],
  ["string type array", 'string[] x = ["hello", "world"]'],
  ...
  ["while greater than", "tide 1 < 2{ cast: 1} "],
